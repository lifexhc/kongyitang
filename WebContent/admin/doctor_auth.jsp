  ...
  <div data-role="page">
    ...
    request.setCharacterEncoding("UTF-8");
 	String url = "index.jsp";
  	...
  	||null==site_id_string||site_id_string.equals("")||null==title||title.equals("")
  	||null==master||master.equals("")||null==department||department.equals("")
  	||null==certified_type||certified_type.equals("")||null==visti_fee_string||visti_fee_string.equals("")
  	||null==userTel||userTel.equals("")||null==introduction||introduction.equals("")){
		%>
		...
		<%	
  		...
  		int visti_fee = Integer.parseInt(visti_fee_string);
