...
<center>
    <form method="post" name="doctorForm" id="doctorForm" action="doctor_auth.jsp" encType="multipart/form-data"  target="hidden_frame"  >
<!--	     	 <fieldset data-role="fieldcontain">-->
   	...
   	<table  width="70%" border="0" cellspacing="0" cellpadding="0">
    		...
    		<tr>
    			<td width="25%"><div id="MyInput">手机号</div></td>
    			<td width="75%"><input id="userTel" name="userTel" type="text" value="" /></td>
    			<td><a style="color:red;">&nbsp;&nbsp;*</a></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td width="75%"><input id="title" name="title" type="text" value="" /></td>
    			<td><a style="color:red;">&nbsp;&nbsp;*</a></td>
    		</tr>
    		<tr>
    			<td width="25%"><div id="MyInput">师&nbsp;&nbsp;&nbsp;&nbsp;承</div></td>
    			<td width="75%"><input id="master" name="master" type="text" value="" /></td>
    			<td><a style="color:red;">&nbsp;&nbsp;*</a></td>
    		</tr>
    		<tr>
    		...
    		<tr>
    			...
    			<td width="75%"><input id="certified_type" name="certified_type" type="text" value="" /></td>
    			<td><a style="color:red;">&nbsp;&nbsp;*</a></td>
    		</tr>
    		<tr>
    			<td width="25%"><div id="MyInput">出诊费</div></td>
    			<td width="75%"><input id="visti_fee" name="visti_fee" type="text" value="" /></td>
    			<td><a style="color:red;">&nbsp;&nbsp;*</a></td>
    		</tr>
    		<tr>
