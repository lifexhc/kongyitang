...
<p>
	健康咨询评估,是秉承中医治未病思想和养生防病理念,针对困扰人们的亚健康问题和一些疾患症状而设立的、具有鲜明中医特色的健康咨询评估项目。通过孔医堂专业医师在解析西医体检报告的基础上，进行中医“望、闻、问、切”四诊合参，辨证分型,并结合孔医堂特有的体质分类方法，做出您的健康状况评估,据此量身定制，提供一整套具有个性化、针对性的健康调理指导方案,从而增强您的健康水平,生活质量和幸福指数。
</p>
<p>
