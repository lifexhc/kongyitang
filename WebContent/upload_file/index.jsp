...
<!--		<input type="file" id="uploadImage" name="uploadImage" onchange="hiddenMsg();" style="display:none" value="浏览"/>-->
		<input type="file" id="uploadImage" name="uploadImage" onchange="hiddenMsg();" value="浏览"/>
